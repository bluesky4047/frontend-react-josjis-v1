...
export const ordersApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    // Endpoint untuk PUT /orders/:id - Mutation untuk update order berdasarkan ID.
    updateOrder: builder.mutation({
      ...
      invalidatesTags: ["Orders"], // Invalidasi cache setelah update.
    }),

    // Endpoint untuk DELETE /orders/:id - Mutation untuk menghapus order.
    deleteOrder: builder.mutation({
      query: (id) => ({
        url: `/orders/${id}`,
        method: "DELETE",
      }),
      invalidatesTags: ["Orders"], // Invalidasi cache setelah delete.
    }),
  }),
});
...
// Contoh: useGetOrdersQuery() untuk fetch orders, useCreateOrderMutation() untuk membuat order baru.
export const {
  useGetOrdersQuery,
